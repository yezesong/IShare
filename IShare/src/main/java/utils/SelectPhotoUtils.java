...
import com.magcomm.ishare.ui.activitys.CropImageActivity;
import com.magcomm.ishare.ui.activitys.UserInfoActivity;
...
public class SelectPhotoUtils {
    ...
    public void select(int mode, int x, int y) {
        ...
        BaseDialog.Builder builder = new BaseDialog.Builder(mContext, R.style.Dialog_SelectPhoto);
    ...
    public void onActivityResult(int requestCode, int resultCode, Intent data) {
        ...
        if (resultCode == Activity.RESULT_CANCELED) {
            Toast.makeText(mContext, R.string.crop_photo_error, Toast.LENGTH_SHORT).show();
            return;
        }
        ...
        switch (requestCode) {
            ...
            case Request.REQUEST_CROP:
                ...
                break;
            case UserInfoActivity.FLAG_EDIT_NICKNAME:
                if (data != null) {
                    if (mCallBack != null) {
                        mCallBack.updateNick(data.getStringExtra("nickname"));
                    }
                }
                break;
