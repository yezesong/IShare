...
/**
 * 作者:Created by yezesong on 16-3-24:19
 * 邮箱: yezesong@magcomm.cn
 */
public class ShareJsonObjectRequest extends JsonRequest<JSONObject> {
    ...
    public ShareJsonObjectRequest(String url, String stringRequest,
