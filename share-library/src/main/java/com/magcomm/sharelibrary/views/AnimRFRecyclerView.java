...
import com.magcomm.sharelibrary.decoration.DividerGridItemDecoration;
import com.magcomm.sharelibrary.decoration.DividerItemDecoration;
import com.magcomm.sharelibrary.listener.OverScrollListener;
import com.magcomm.sharelibrary.manager.AnimRFGridLayoutManager;
import com.magcomm.sharelibrary.manager.AnimRFLinearLayoutManager;
import com.magcomm.sharelibrary.manager.AnimRFStaggeredGridLayoutManager;
...
public class AnimRFRecyclerView extends RecyclerView implements Runnable {
    ...
    private int progressColor = getResources().getColor(R.color.color_light_green);//Color.WHITE;
    int bgColor = getResources().getColor(R.color.color_dark_green);//Color.WHITE; // 刷新View的颜色
     ...
     * 设置刷新和加载更多数据的监听
     *
     * @param listener {@link com.magcomm.sharelibrary.views.AnimRFRecyclerView.LoadDataListener}
     */
    ...
    public void setAdapter(Adapter adapter) {
        ...
        if (mFootViews.isEmpty()) {
            ...
            text.setText(R.string.onloading);
    ...
    private void refresh() {
        ...
        if (rfAnimView == null) {
            ...
            RelativeLayout.LayoutParams params = new RelativeLayout.LayoutParams(
                    AnimView.dip2px(mContext, 33), AnimView.dip2px(mContext, 60));
